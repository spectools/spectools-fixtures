/* ReSpec 3.2.31 - Robin Berjon, http://berjon.com/ (@robinberjon) */
/* Documentation: http://w3.org/respec/. */
/* See original source for licenses: https://github.com/darobin/respec. */
respecVersion = '3.2.31';
    ...
    function ha(e) {
        ...
        function m() {
            ...
            if (!x) {
                if (x = !0, F(D, function(i) {
                    ...
                    if (!i.inited && i.fetched && e.isDefine && (c = !0, !e.prefix)) return u = !1
        ...
        return k = {
            ...
            completeLoad: function(e) {
                var t, n, i = l(T.shim, e) || {}, a = i.exports;
                for (d(); L.length;) {
...
function(e, t) {
    ...
    at.fn = at.prototype = {
        ...
        var e, n, r, i, a, s, o = arguments[0] || {}, l = 1,
            c = arguments.length,
            u = !1;
...
function() {
    ...
    d.bullet = /(?:[*+-]|\d+\.)/, d.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, d.item = l(d.item, "gm")(/bull/g, d.bullet)(), d.list = l(d.list)(/bull/g, d.bullet)("hr", /\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)(), d.html = l(d.html)("comment", /<!--[^\0]*?-->/)("closed", /<(tag)[^\0]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, o())(), d.paragraph = l(d.paragraph)("hr", d.hr)("heading", d.heading)("lheading", d.lheading)("blockquote", d.blockquote)("tag", "<" + o())("def", d.def)(), d.normal = {
        ...
        if (a = d.fences.exec(e)) e = e.substring(a[0].length), t.push({
            type: "code",
            lang: a[2],
            text: a[3]
        });
    ...
    f._linkInside = /(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/, f._linkHref = /\s*<?([^\s]*?)>?(?:\s+['"]([^\0]*?)['"])?\s*/, f.link = l(f.link)("inside", f._linkInside)("href", f._linkHref)(), f.reflink = l(f.reflink)("inside", f._linkInside)(), f.normal = {
        ...
        if (o = f.autolink.exec(t)) t = t.substring(o[0].length), "@" === o[2] ? (r = ":" === o[1][6] ? s(o[1].substring(7)) : s(o[1]), i = s("mailto:") + r) : (r = a(o[1]), i = r), l += '<a href="' + i + '">' + r + "</a>";
...
}), define("core/biblio", [], function() {
    var e = function(e) {
        var t = e.informativeReferences,
            n = e.normativeReferences,
            r = [],
            i = function(e) {
                var t = [];
        ...
        for (var a in t) n[a] && r.push(a);
        for (var s = 0; s < r.length; s++) delete t[r[s]];
        return {
            informativeReferences: i(t),
            normativeReferences: i(n)
        }
    }, t = {
            NOTE: "W3C Note",
            ...
            var n = "";
            return e.authors && e.authors.length && (n += e.authors.join("; "), e.etAl && (n += " et al"), n += ". "), n += e.href ? '<a href="' + e.href + '"><cite>' + e.title + "</cite></a>. " : "<cite>" + e.title + "</cite>. ", e.date && (n += e.date + ". "), e.status && (n += (t[e.status] || e.status) + ". "), e.href && (n += 'URL: <a href="' + e.href + '">' + e.href + "</a>"), n
        }, r = function(t, r) {
            var i = {}, a = e(t),
                s = a.informativeReferences,
                o = a.normativeReferences,
                l = {};
            if (s.length || o.length || t.refNote) {
                var c = $("<section id='references' class='appendix'><h2>References</h2></section>").appendTo($("body"));
                t.refNote && $("<p></p>").html(t.refNote).appendTo(c);
                for (var u = ["Normative", "Informative"], p = 0; p < u.length; p++) {
                    var d = u[p],
                        a = "Normative" == d ? o : s;
                    if (a.length) {
                        var f = $("<section><h3></h3></section>").appendTo(c).find("h3").text(d + " references").end();
                        f.makeID(null, d + " references"), a.sort();
                        var h = $("<dl class='bibliography'></dl>").appendTo(f);
                        t.doRDFa !== !1 && h.attr("about", "");
                        for (var m = 0; m < a.length; m++) {
                            var g = a[m];
                            $("<dt></dt>").attr({
                                id: "bib-" + g
                            }).text("[" + g + "]").appendTo(h);
                            var b = $("<dd></dd>").appendTo(h);
                            this.doRDFa !== !1 && ("Normative" === d ? b.attr("rel", "dcterms:requires") : b.attr("rel", "dcterms:references"));
                            var v = t.biblio[g],
                                y = {}, x = g;
                            for (y[g] = !0; v && v.aliasOf;) y[v.aliasOf] ? (v = null, r.pub("error", "Circular reference in biblio DB between [" + g + "] and [" + x + "].")) : (x = v.aliasOf, v = t.biblio[x], y[x] = !0);
                            l[x] = l[x] || [], l[x].indexOf(g) < 0 && l[x].push(g), v ? b.html(n(v) + "\n") : (i[g] || (i[g] = 0), i[g]++, b.html("<em style='color: #f00'>Reference not found.</em>\n"))
                        }
                    }
                }
                for (var w in l) l[w].length > 1 && r.pub("warn", "[" + w + "] is referenced in " + l[w].length + " ways (" + l[w].join(", ") + "). This causes duplicate entries in the reference section.");
                for (var C in i) i.hasOwnProperty(C) && r.pub("error", "Bad reference: [" + C + "] (appears " + i[C] + " times)")
            }
        };
    return {
        stringifyRef: n,
        run: function(t, n, i, a) {
            a.pub("start", "core/biblio");
            var s = e(t),
                o = [],
                l = function() {
                    a.pub("end", "core/biblio"), i()
                };
            if (t.localBiblio)
                for (var c in t.localBiblio) "undefined" != typeof t.localBiblio[c].aliasOf && o.push(t.localBiblio[c].aliasOf);
            if (s = s.normativeReferences.concat(s.informativeReferences).concat(o), s.length) {
                var u = "https://specref.jit.su/bibrefs?refs=" + s.join(",");
                setTimeout(function(e) {
                    var e = {
                        ...
                        "DOM-Level-3-Events": {
                            ...
                            "edDraft": "https://dvcs.w3.org/hg/dom3events/raw-file/tip/html/DOM3-Events.html",
                        ...
                        "WebIDL": {
                            ...
                            "edDraft": "http://heycam.github.io/webidl/",
                        ...
                        "dom": {
                            ...
                            "edDraft": "http://w3c.github.io/dom/",
                        ...
                        "webstorage": {
                            ...
                            "edDraft": "http://dev.w3.org/html5/webstorage/",
                            "href": "http://www.w3.org/TR/webstorage/",
                            "id": "webstorage",
                            "publisher": "W3C",
                            "status": "REC",
                            "title": "Web Storage"
                    ...
                    if (t.biblio = e || {}, t.localBiblio)
                        for (var n in t.localBiblio) t.biblio[n] = t.localBiblio[n];
                    r(t, a), l()
                }, 200);
            } else l()
        }
...
define("core/webidl-oldschool", ["handlebars", "tmpl!core/css/webidl-oldschool.css", "tmpl!core/templates/webidl/module.html", "tmpl!core/templates/webidl/typedef.html", "tmpl!core/templates/webidl/implements.html", "tmpl!core/templates/webidl/dict-member.html", "tmpl!core/templates/webidl/dictionary.html", "tmpl!core/templates/webidl/enum-item.html", "tmpl!core/templates/webidl/enum.html", "tmpl!core/templates/webidl/const.html", "tmpl!core/templates/webidl/param.html", "tmpl!core/templates/webidl/callback.html", "tmpl!core/templates/webidl/method.html", "tmpl!core/templates/webidl/constructor.html", "tmpl!core/templates/webidl/attribute.html", "tmpl!core/templates/webidl/serializer.html", "tmpl!core/templates/webidl/comment.html", "tmpl!core/templates/webidl/field.html", "tmpl!core/templates/webidl/exception.html", "tmpl!core/templates/webidl/interface.html"], function(e, t, n, r, i, a, s, o, l, c, u, p, d, f, h, m, g, b, v, y) {
    ...
    return x.prototype = {
        ...
        processEnumMember: function(e, t) {
            ...
            return n.description = t.contents(), r = this.parseExtendedAttributes(r, n), n.type = "member", this.setID(n, r || "EMPTY"), n.refId = sn.sanitiseID(n.id), n
        },
                        ...
                        if (d = d.substr(0, 1).toUpperCase() + d.substr(1) + ("serializer" != c ? "s" : ""), this.conf.noIDLSectionTitle || sn.element("h2", {}, p, d), "serializer" != c)
                            for (var f = sn.element("dl", {
                                ...
                                if ("method" == c || "constructor" == c) {
                                    ...
                                    } else sn.element("div", {}, b, [sn.element("em", {}, null, "No parameters.")]); if (this.conf.idlOldStyleExceptions && m.raises.length) {
                                        var D = sn.element("table", {
                                            "class": "exceptions"
                                        }, b),
                                            C = sn.element("tr", {}, D);
